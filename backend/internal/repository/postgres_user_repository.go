...
func (r *PostgresUserRepository) CreateSession(session models.Session) error {
	_, err := r.DB.Exec(`
...
func (r *PostgresUserRepository) GetSessionByToken(token string) (*models.Session, error) {
